...
ASFLAGS = -f bin
CC = gcc
OBJECTS = bootpack.o io.o graphic.o int.o desctbl.o fifo.o keyboard.o mouse.o memory.o sheet.o timer.o
CFLAGS = -c -m32 -nostartfiles -fno-stack-protector -ffreestanding -Werror
